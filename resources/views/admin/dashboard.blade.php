                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{URL::to('/insert')}}">Add User</a>
                                </li>
                                <li>
                                    <a href="{{URL::to('/manage')}}">Manage User</a>
                                </li>
                            </ul>
                           
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Cetegory<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{URL::to('/category/add')}}">Add Cetegory</a>
                                </li>
                                <li>
                                    <a href="{{URL::to('/category/manage')}}">Manage Category</a>
                                </li>
                            </ul>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{URL::to('/product/add')}}">Add Product</a>
                                </li>
                                <li>
                                    <a href="{{URL::to('/product/manage')}}">Manage Product</a>
                                </li>
                            </ul>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{URL::to('/tag/add')}}">Add Tag</a>
                                </li>
                                <li>
                                    <a href="{{URL::to('/tag/manage')}}">Manage Tag</a>
                                </li>
                            </ul>
                           ...
                           <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{URL::to('/post/add')}}">Add Post</a>
                                </li>
                                <li>
                                    <a href="{{URL::to('/post/manage')}}">Manage Post</a>
                                </li>
                            </ul>
